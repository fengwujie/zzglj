...
@interface WJNewsSingleView2Controller ()
/**
 *  新闻数组
 */
...
@implementation WJNewsSingleView2Controller
...
{
    // 1.封装请求参数
    WJNewsSingleParam *param = [WJNewsSingleParam param];
    ...
    // 2.加载新闻列表
    [WJNewsSingleTools newsWithParam:param success:^(WJNewsReturn *result) {
        // 获得最新的新闻News数组
