...
#import "WJNewsSingleTools.h"
#import "WJNews.h"
#import "MJExtension.h"
#import "WJHttpTool.h"

@implementation WJNewsSingleTools

+ (void)newsWithParam:(WJNewsSingleParam *)param success:(void (^)(WJNewsReturn *))success failure:(void (^)(NSError *))failure
{
    param.methodName = @"NewsToJsonPage";
    NSString *soapMessage = [NSString stringWithFormat:
                             ...
                             param.methodName,param.size, param.lmid,param.minid,param.maxid,param.keyWord,param.str, param.methodName];
